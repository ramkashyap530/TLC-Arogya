...
<div class="row">
                                        <div class="form-group col-md-1">
                                            ...
                                            <select class="form-control" id="bill_type" onchange="bill_type_bi()">
                                                <option></option>
                                        ...
                                        <div class="form-group col-md-2" hidden="" id="bill_ipd">
                                            <label for="fname">IPD No</label>
                                            <select class="form-control" >
                                                <option></option>
                                                <%
                                                    WPHR0001_Dao IPD_no = new WPHR0001_Dao();
                                                    ArrayList<String> data_ipd = IPD_no.getdata("2", Hospital_code);
                                                    for (String cd : data_ipd) {
                                                        out.println(cd);
                                                    }
                                                %>
                                        ...
                                        <div class="form-group col-md-2" hidden="" id="bill_opd">
                                            <label for="fname">OPD  No</label>
                                            <select class="form-control" >
                                                <option></option>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="purchase_price" placeholder="" name="bill_mobile" onkeyup="sale_price_cost()">
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="Tax" placeholder="" name="bill_name" onkeyup="sale_price_cost()">
                                        </div>

                                        <div class="form-group col-md-3">
                                            <label for="fname">Address</label>
                                            <input type="text" class="form-control" id="sale" placeholder="" name="bill_address">
                                        </div>
                                        ...
                                        <input type="text" class="form-control" id="qty" placeholder="Qty" name="">
                                    </div>

                                    <div class="form-group col-md-2">
                                        <center> <button class="btn btn-sm btn-success" type="button" onclick="add_to_bill();">Add To Bill</button></center>
                                    </div>
...
<!--                                        <select class='form-control' id="prd_cd" name='prd_cd'>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="iq-card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text"  id="SGST"  onkeyup="final_bill_amount();"   value="0"  name='extra_charge'  class="form-control form-control-sm">
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text"  id="CGST"  onkeyup="final_bill_amount();"   value="0"  name='extra_charge'  class="form-control form-control-sm">
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <center><button class="btn btn-sm btn-primary">save/Print </button></center>
                                </div>
                            </div>
