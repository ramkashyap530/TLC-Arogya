                                     ...
                                     <div class="row">
                                         <div class="col-md-4">
                                            <label>OT Amount </label>
                                             <input type="text" class="form-control" id="fname" placeholder="" name="OT_Amount">
                                            </div>
                                         ...
                                         <div class="col-md-4">
                                            <label>Pending</label>
                                             <input type="text" class="form-control" id="fname" placeholder="" name="Amount_pending">
                                            </div>
