...
@WebServlet(name = "IPD_BILL_PRINT", urlPatterns = {"/IPD_BILL_PRINT"})
public class IPD_BILL_PRINT extends HttpServlet {
                ...
                con=new DBCon().getConnection();
                     ...
                     // String reporttype ="xlsx";//request.getParameter("reportformat");
                      ...
                      if("pdf".equalsIgnoreCase(reporttype))
                      {
                        ...
                        response.setHeader("Content-Disposition",  "inline; filename=\"Provisional_bill"+Patient_id+".pdf\"");
                      ...
                      else if("xlsx".equalsIgnoreCase(reporttype)  )
                      {
                        ...
                        response.setHeader("Content-Disposition",  "inline; filename=\"Provisional_bill"+Patient_id+".xlsx\"");
