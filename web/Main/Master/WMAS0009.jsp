...
<html>
    ...
    <body onload="get_hospital_details()">
        <div class="wrapper">
                     ...
                     <div class="iq-card">
                        ...
                        <input type="hidden" value="<%=Hospital_code%>" name="hospital_code">
                              ...
                              <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <label for="validationDefault01">Hospital Name</label>
                                    <input type="text" class="form-control" id="validationDefault01"  name="Hospital_name" required>
                             
                                 </div> 
                                  <div class="col-md-4 mb-3">
                                                                       
                                    <label for="validationDefault01">Hospital Registration</label>
                                    <input type="text" class="form-control" id="validationDefault01"  name="Hospital_reg" required>
                                  ...
                                  <div class="col-md-4 mb-3">
                                    ...
                                    <label for="validationDefault01">Hospital Gst</label>
                                    <input type="text" class="form-control" id="validationDefault01"  name="Hospital_gst" required>
                                  ...
                                  <div class="col-md-4 mb-3">
                                    ...
                                    <label for="validationDefault01">Hospital Address</label>
                                    <input type="text" class="form-control" id="validationDefault01"  name="Hospital_address" required>
                                    ...
                                    <label for="validationDefault01">Number 1</label>
                                    <input type="text" class="form-control" id="validationDefault01"  name="number_1" required>
                             
                                 </div> 
                                  
                                    <div class="col-md-4 mb-3">
                                                                       
                                    <label for="validationDefault01">Number 2</label>
                                    <input type="text" class="form-control" id="validationDefault01"  name="number_2" required>
                        ...
                        <label for="validationDefault01">Logo</label>
                                                   <div class="form-group mt-4">
                                                       ...
                                                       <input type="file" id="file_adhar"  name="prd_photo_logo" class="form-control mt-1">
                        ...
                        <table class="table table-bordered table-responsive-md table-striped text-center" id="M_tab">
                                 <thead>
                                    <tr>
                                       ...
                                       <th style="white-space: nowrap">Number 1</th>
                                       <th style="white-space: nowrap">Number 2</th>
