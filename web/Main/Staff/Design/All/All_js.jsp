<%-- 
    Document   : All_js
    Created on : 2 Feb, 2022, 12:55:14 PM
    Author     : Tarun
--%>
...
<!-- Optional JavaScript -->
    ...
    <script src="../../Design/All/js/jquery.min.js"></script>
      ...
      <!-- lottie JavaScript -->
      <script src="../../Design/All/js/lottie.js"></script>
      <!-- am core JavaScript -->
      <script src="../../Design/All/js/core.js"></script>
      <!-- am charts JavaScript -->
      <script src="../Design/All/js/charts.js"></script>
      <!-- am animated JavaScript -->
      <script src="../../Design/All/js/animated.js"></script>
      <!-- am kelly JavaScript -->
      <script src="../../Design/All/js/kelly.js"></script>
      <!-- Flatpicker Js -->
      ...
      <script src="../../Designs/All/daterangepicker/daterangepicker.js"></script>
