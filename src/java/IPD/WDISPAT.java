 ...
 * @author Tarun
 */
@WebServlet(name = "WDISPAT", urlPatterns = {"/WDISPAT"})
public class WDISPAT extends HttpServlet {
Connection con;
    ...
    String patiemt_id =request.getParameter("patient_id");
        String docnm ="discharge_pat";
            try{
             ...
             Logger.getLogger(WDISPAT.class.getName()).log(Level.SEVERE, null, e);
        }
