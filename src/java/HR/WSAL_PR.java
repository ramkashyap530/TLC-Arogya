 ...
 * @author Tarun
 */
@WebServlet(name = "WSAL_PR", urlPatterns = {"/WSAL_PR"})
public class WSAL_PR extends HttpServlet {
Connection con;
            ...
            try{
                ...
                con=new DBCon().getConnection();
                     ...
                     // String reporttype ="xlsx";//request.getParameter("reportformat");
                      ...
                      jasperParameter.put("slip_no",slip_no);
                      ...
                      if("pdf".equalsIgnoreCase(reporttype))
                      {
                        ...
                        response.setHeader("Content-Disposition",  "inline; filename=\"SalarySlip_"+slip_no+".pdf\"");
                      ...
                      else if("xlsx".equalsIgnoreCase(reporttype)  )
                      {
                        ...
                        response.setHeader("Content-Disposition",  "inline; filename=\"face_sheet"+slip_no+".xlsx\"");
             ...
             Logger.getLogger(WSAL_PR.class.getName()).log(Level.SEVERE, null, e);
        }
