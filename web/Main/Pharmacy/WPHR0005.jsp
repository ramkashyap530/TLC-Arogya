               ...
               <div class="row">
                     ...
                     <div class="iq-card">
                         ...
                         <div class="iq-card-body">
                             ...
                             <div class="form-group col-md-12">
                                 <label for="fname">Date From</label><!-- comment -->
                                 <input type="date" class="form-control" name="date_from" id="date_from">
                                 </div>
                             
                             
                             <div class="form-group col-md-12">
                                 <label for="fname">Date To</label><!-- comment -->
                                 <input type="date" class="form-control" name="date_from" id="date_from">
                                 </div>
                  ...
                  <div class="col-lg-10">
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Sale Book</h4>
                           </div>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-10">
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Purchase Book</h4>
                           </div>
