<%-- 
    Document   : WOC0002
    Created on : 09-Apr-2022, 8:55:22 pm
    Author     : Ram
--%>
                        ...
                        <div class="iq-card">
                           <div class="iq-card-header d-flex justify-content-between">
                              <div class="iq-header-title">
                                 <h4 class="card-title">Charge Remaining Payment</h4>
                              </div>
                           ...
                           <div class="iq-card-body">
                              ...
                              <div class="form-group" id="ipd_patient" >
                                 ...
                                 <select class="form-control" id="patient_id" name="patient_id" required onchange="get_oc_assign2();">
                                    <option>Select</option>
                                    <%
                                 ...
                                 <label>Patient Name</label>
                                 <select class="form-control" id="patient_id_opd" name="patient_id" required onchange="get_oc_assign2();">
                                    <option>Select</option>
                                    <%
                                       WOC0001_Dao st_2 = new WOC0001_Dao();
                                       ArrayList<String> data_opd = st_2.getdata("2", "");
