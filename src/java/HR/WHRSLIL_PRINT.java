 ...
 * @author Tarun
 */
@WebServlet(name = "WHRSLIL_PRINT", urlPatterns = {"/WHRSLIL_PRINT"})
public class WHRSLIL_PRINT extends HttpServlet {
Connection con;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String StfSlry_Id =request.getParameter("Emp_id");
        String docnm ="SalarySlip";
            try{
                ...
                con=new DBCon().getConnection();
                     ...
                     // String reporttype ="xlsx";//request.getParameter("reportformat");
                      ...
                      jasperParameter.put("StfSlry_Id",StfSlry_Id);
                      ...
                      if("pdf".equalsIgnoreCase(reporttype))
                      {
                        ...
                        response.setHeader("Content-Disposition",  "inline; filename=\"SalarySlip_"+StfSlry_Id+".pdf\"");
                      ...
                      else if("xlsx".equalsIgnoreCase(reporttype)  )
                      {
                        ...
                        response.setHeader("Content-Disposition",  "inline; filename=\"SalarySlip_"+StfSlry_Id+".xlsx\"");
             ...
             Logger.getLogger(WHR0001_SERV.class.getName()).log(Level.SEVERE, null, e);
        }
    }
