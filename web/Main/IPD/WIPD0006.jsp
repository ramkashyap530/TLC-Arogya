      ...
      <div class="wrapper">
         ...
         <div id="content-page" class="content-page">
            ...
            <div class="container-fluid">
               <form action="../../WIPD0002_serv" method="post" id="form1">  
                  ...
                  <div class="row">
                        ...
                        <div class="iq-card">
                           <div class="iq-card-header d-flex justify-content-between">
                              <div class="iq-header-title">
                                 <h4 class="card-title">Other Charge</h4>
                              </div>
                           ...
                           <div class="iq-card-body">
                              ...
                              <div class="form-group" id="ipd_patient">
                                 ...
                                 <select class="form-control" id="patient_id" name="patient_name_id" required onchange="get_other_Charge_assign_pending();">
                                    <option>Select</option>
                                    <%
                        ...
                        <div class="iq-card">
                           <div class="iq-card-header d-flex justify-content-between">
                              <div class="iq-header-title">
                               ...
                               <div class="col-md-4">
                               <input type="test" name="auto_paid" class="form-control" id="auto_paid" placeholder="Auto Paid" value="0" onkeyup="autoPaid(this.value);">
                               </div>
                     ...
                     <div class="col-lg-3">
                        <div class="iq-card">
                           <div class="iq-card-header d-flex justify-content-between">
                              <div class="iq-header-title">
                                 <h4 class="card-title">Total <span  class='badge bg-warning'id="tot_test_amt">0</span> &#8377</h4>
                              </div>
                              <button class="btn btn-success "  type="button" data-toggle="modal" data-target="#exampleModalCenter" onclick="get_lab_patient_id(); return;"  >Check</button>
                           </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="exampleModalCenterTitle">Charge Total Amount</h5>
                                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                 </button>
                              </div>
                              <div class="modal-body">
                                 <input type="hidden" readonly name="patient_id_mod" id="patient_id_mod">
                                 <div class="row">
                                    <div class="col-md-4">
